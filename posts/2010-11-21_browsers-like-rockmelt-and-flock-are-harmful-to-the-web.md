---
title: "Browsers like RockMelt and Flock are Harmful to the Web"
date: 2010-11-21T16:21:45-05:00
url: https://newcome.wordpress.com/2010/11/21/browsers-like-rockmelt-and-flock-are-harmful-to-the-web/
id: 1208
...
![](images/2010-11-21_browsers-like-rockmelt-and-flock-are-harmful-to-the-web_rockmelt-logo_0.png)

I recently received a beta invite for the new [RockMelt](http://www.rockmelt.com/) Web browser, which is funded by Andreessen Horowitz, of Marc Andreessen/Netscape fame. Naturally I was curious to see what they are working on, Andreessen knowing a thing or two about the browser market, having been instrumental in the birth of the segment in the early nineties.

However, another part of me remained skeptical, having tried out the [Flock](http://flock.com/) browser, which appears to be a similar idea but based around Mozilla/Gecko rather than Chrome/Webkit as RockMelt is.
...
One alternative that could bridge the gap between where we are now and future Web support for social networking features would be something like what [GroupDock](http://groupdock.com/) is doing. GroupDock is a commercial product that a friend and fellow entrepreneur [Luc Castera](http://dambalah.com/) is working on, but the idea is to allow the delivery of small apps that are built on OpenSocial and Sproutcore. If we twist this idea around slightly and allow these small apps to be more integrated into the browser, we might have a perfect blend between accommodating service-specific apps while not treating the browser as a glorified thick client for specific services.
